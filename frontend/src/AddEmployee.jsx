...
function AddEmployee() {
  ...
  // Function to handle form submission
	const handleSubmit = (event) => {
    	...
    	// Send a POST request to the server to create a new employee
		...
		<div className='d-flex flex-column align-items-center pt-4'>
			...
			<form class="row g-3 w-50" onSubmit={handleSubmit}>
				...
				<div class="col-12">
					...
					<input type="password" class="form-control" id="inputPassword4" placeholder='Enter Password' onChange={e => setData({...data, password: e.target.value})}/>
				</div>
				<div class="col-12">
				...
				<div class="col-12">
					...
					<input type="text" class="form-control" id="inputAddress" placeholder="Enter address" autoComplete='off' onChange={e => setData({...data, address: e.target.value})}/>
				</div>
